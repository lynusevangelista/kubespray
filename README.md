...
- Core
  ...
  - [etcd](https://github.com/etcd-io/etcd) 3.5.30
  - [docker](https://www.docker.com/) 28.3
  - [containerd](https://containerd.io/) 2.1.7
  - [cri-o](http://cri-o.io/) 1.33.12 (experimental: see [CRI-O Note](docs/CRI/cri-o.md). Only on fedora, ubuntu and centos based OS)
- Network Plugin
